...
if __name__ == '__main__':
    ...
    dst_dss = drv.Create('E:/simulated data/EU/LAI001/longestLAIevent_001_730_phenology.tiff', Ny,Nx,730, gdal.GDT_Float32,options=[ "INTERLEAVE=BAND", "TILED=YES","BIGTIFF=YES","COMPRESS=LZW"])
...
src_filename = 'E:/simulated data/EU/LAI001/longestLAIevent_001_730_phenology.tiff'
...
Nx,Ny=2500,4000
drv = gdal.GetDriverByName("GTIFF")
dst_ds = drv.Create('E:/simulated data/EU/LAI001/longestLAI_onset_001_phenology.tiff', Ny,Nx,1, gdal.GDT_Float32,options=[ "INTERLEAVE=BAND", "TILED=YES","COMPRESS=LZW"])
