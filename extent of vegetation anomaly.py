...
def wirteoutfile(src,dst_ds,value):
    ...
    for x in range(0,xsize,block_xsize):
        ...
        for y in range(0,ysize,block_ysize):
            ...
            print(x,y)     
            #calculate extent 
            abLAI_block_sum=get_ablaibsum(abLAI_block,value)
...
dst_ds = drv.Create('E:/EU/LAI001/abLAIb1sum_EU_001_cutphenology.tiff', Ny,Nx,1, gdal.GDT_Float32,options=[ "INTERLEAVE=BAND", "TILED=YES"])
