...
dst_ds = drv.Create('E:/EU/LAI001/abLAIb1_EU_001_cutphenology_accum.tiff', Ny,Nx,730, gdal.GDT_Float32,options=[ "INTERLEAVE=BAND", "TILED=YES","BIGTIFF=YES","COMPRESS=LZW"])
