...
#read LAI data
src_filename = 'E:/simulated data/EU/LAI001/LAI_0418_001_eu.tiff'
...
dst_ds = drv.Create('E:/simulated data/EU/LAI001/abLAIblock_EU_001_10day.tiff', Ny,Nx,36, gdal.GDT_Float32,options=[ "INTERLEAVE=BAND", "TILED=YES","BIGTIFF=YES","COMPRESS=LZW"])
...
Nx,Ny=2500,4000
drv = gdal.GetDriverByName("GTIFF")
dst_ds = drv.Create('E:/simulated data/EU/LAI001/abLAIblock_EU_001_10day_2017.tiff', Ny,Nx,36, gdal.GDT_Float32,options=[ "INTERLEAVE=BAND", "TILED=YES","BIGTIFF=YES","COMPRESS=LZW"])
dst_ds.SetGeoTransform(src_geotrans)
dst_ds.SetProjection(src_proj)                        
...
#read abLAI 2017
src_filename = 'E:/simulated data/EU/LAI001/abLAIblock_EU_001_10day_2017.tiff'
src = gdal.Open(src_filename, gdalconst.GA_ReadOnly)
src_proj = src.GetProjection()
src_geotrans = src.GetGeoTransform()
...
Nx,Ny=2500,4000
drv = gdal.GetDriverByName("GTIFF")
dst_ds = drv.Create('E:/simulated data/EU/LAI001/abLAI365block_EU_001_2017.tiff', Ny,Nx,365, gdal.GDT_Float32,options=[ "INTERLEAVE=BAND", "TILED=YES","BIGTIFF=YES","COMPRESS=LZW"])
dst_ds.SetGeoTransform(src_geotrans)
dst_ds.SetProjection(src_proj)
...
import pandas as pd
#read abLAI2018
src_filename = 'E:/simulated data/EU/LAI001/abLAIblock_EU_001_10day.tiff'
src = gdal.Open(src_filename, gdalconst.GA_ReadOnly)
src_proj = src.GetProjection()
src_geotrans = src.GetGeoTransform()
...
Nx,Ny=2500,4000
drv = gdal.GetDriverByName("GTIFF")
dst_ds = drv.Create('E:/simulated data/EU/LAI001/abLAI365block_EU_001.tiff', Ny,Nx,365, gdal.GDT_Float32,options=[ "INTERLEAVE=BAND", "TILED=YES","BIGTIFF=YES","COMPRESS=LZW"])
dst_ds.SetGeoTransform(src_geotrans)
dst_ds.SetProjection(src_proj)
...
#read abLAI 2018
src_filename = 'E:/simulated data/EU/LAI001/abLAI365block_EU_001.tiff'
src = gdal.Open(src_filename, gdalconst.GA_ReadOnly)
src_proj = src.GetProjection()
src_geotrans = src.GetGeoTransform()     

#read abLAI 2017
srcc_filename = 'E:/simulated data/EU/LAI001/abLAI365block_EU_001_2017.tiff'
...
Nx,Ny=2500,4000
drv = gdal.GetDriverByName("GTIFF")
dst_ds = drv.Create('E:/simulated data/EU/LAI001/abLAIblock_EU_001_365_1718.tiff', Ny,Nx,730, gdal.GDT_Float32,options=[ "INTERLEAVE=BAND", "TILED=YES","BIGTIFF=YES","COMPRESS=LZW"])
dst_ds.SetGeoTransform(src_geotrans)
dst_ds.SetProjection(src_proj)                        
...
src_filename = 'E:/simulated data/EU/LAI001/abLAIblock_EU_001_365_1718.tiff'
src = gdal.Open(src_filename, gdalconst.GA_ReadOnly)
src_proj = src.GetProjection()
src_geotrans = src.GetGeoTransform()     

src2_filename = 'E:/simulated data/EU/LAI001/phen_sosall_merge_transferto730_m1096_001.tiff'
src2 = gdal.Open(src2_filename, gdalconst.GA_ReadOnly)
src2_proj = src2.GetProjection()
src2_geotrans = src2.GetGeoTransform()     

src3_filename = 'E:/simulated data/EU/LAI001/phen_endall_merge_transferto730_m1096_001.tiff'
src3 = gdal.Open(src3_filename, gdalconst.GA_ReadOnly)
src3_proj = src3.GetProjection()
src3_geotrans = src3.GetGeoTransform()     

#save 365 cut abLAI EU
Nx,Ny=2500,4000
drv = gdal.GetDriverByName("GTIFF")
dst_ds = drv.Create('E:/simulated data/EU/LAI001/abLAIblock_EU_001_730_cutsoseos.tiff', Ny,Nx,730, gdal.GDT_Float32,options=[ "INTERLEAVE=BAND", "TILED=YES","BIGTIFF=YES","COMPRESS=LZW"])
dst_ds.SetGeoTransform(src_geotrans)
dst_ds.SetProjection(src_proj)  
